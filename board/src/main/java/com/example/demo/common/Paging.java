...
@Data
public class Paging {
	int pageUnit=10 ;  //한페이지 출력할 레코드 건수 지정 가능
	...
	// setTotalRecord, getStartPage, getEndPage 사용하여 페이지 자동 계산
	public int getFirst() { // 사용
		first = (getPage() - 1) * getPageUnit() + 1;
		return first;
	}

	public int getLast() { // 사용
